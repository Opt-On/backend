...
import com.opton.spring_boot.transcript_parser.types.SummaryRequest;
...
public class TranscriptController {
    ...
    public ResponseEntity<String> handleTextTranscriptUpload(@RequestParam("file") MultipartFile file, @RequestParam(defaultValue = "true") boolean includeGrade, @RequestParam("email") String email, @RequestParam("transcriptText") String text) {
        if (file.isEmpty()) {
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(null);
        }
    ...
    public ResponseEntity<String> handleJsonTranscriptUpload(@RequestBody SummaryRequest request) {
